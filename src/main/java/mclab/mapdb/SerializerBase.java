...
public class SerializerBase extends Serializer<Object>{
    ...
    protected void initSer() {
        ...
        ser.put(boolean[].class, new SerHeaderSerializer(Header.ARRAY_BOOLEAN, BOOLEAN_ARRAY));
        ser.put(short[].class, new SerHeaderSerializer(Header.ARRAY_SHORT, SHORT_ARRAY));
        ser.put(char[].class, new SerHeaderSerializer(Header.ARRAY_CHAR, CHAR_ARRAY));
        ser.put(float[].class, new SerHeaderSerializer(Header.ARRAY_FLOAT, FLOAT_ARRAY));
        ser.put(double[].class, new SerHeaderSerializer(Header.ARRAY_DOUBLE, DOUBLE_ARRAY));
        ser.put(int[].class, SER_INT_ARRAY);
        ser.put(long[].class, SER_LONG_ARRAY);

        ser.put(BigInteger.class, new SerHeaderSerializer(Header.BIGINTEGER, BIG_INTEGER));
        ser.put(BigDecimal.class, new SerHeaderSerializer(Header.BIGDECIMAL, BIG_DECIMAL));
        ser.put(Class.class, new SerHeaderSerializer(Header.CLASS, CLASS));
        ser.put(Date.class, new SerHeaderSerializer(Header.DATE, DATE));
        ser.put(UUID.class, new SerHeaderSerializer(Header.UUID, UUID));
    ...
    protected void initHeaderDeser(){
        ...
        headerDeser[Header.INT] = new DeserSerializer(INTEGER);
        headerDeser[Header.LONG] = new DeserSerializer(LONG);
        headerDeser[Header.CHAR] = new DeserSerializer(CHAR);
        headerDeser[Header.SHORT] = new DeserSerializer(SHORT);
        headerDeser[Header.FLOAT] = new DeserSerializer(FLOAT);
        headerDeser[Header.DOUBLE] = new DeserSerializer(DOUBLE);
        headerDeser[Header.BYTE] = new DeserSerializer(BYTE);
        ...
        headerDeser[Header.ARRAY_BOOLEAN] = new DeserSerializer(BOOLEAN_ARRAY);
        headerDeser[Header.ARRAY_INT] = new DeserSerializer(INT_ARRAY);
        headerDeser[Header.ARRAY_SHORT] = new DeserSerializer(SHORT_ARRAY);
        headerDeser[Header.ARRAY_DOUBLE] = new DeserSerializer(DOUBLE_ARRAY);
        headerDeser[Header.ARRAY_FLOAT]= new DeserSerializer(FLOAT_ARRAY);
        headerDeser[Header.ARRAY_CHAR]= new DeserSerializer(CHAR_ARRAY);
        headerDeser[Header.ARRAY_BYTE]= new DeserSerializer(BYTE_ARRAY);
        ...
        headerDeser[Header.ARRAY_LONG] = new DeserSerializer(LONG_ARRAY);
        headerDeser[Header.BIGINTEGER] = new DeserSerializer(BIG_INTEGER);
        headerDeser[Header.BIGDECIMAL] = new DeserSerializer(BIG_DECIMAL);
        headerDeser[Header.CLASS] = new DeserSerializer(CLASS);
        headerDeser[Header.DATE] = new DeserSerializer(DATE);
        headerDeser[Header.UUID] = new DeserSerializer(UUID);
    ...
    protected interface HeaderMapDB{
        ...
        protected void initMapdb(){
            ...
            mapdb_add(10, STRING_NOSIZE);
            mapdb_add(11, STRING_ASCII);
            mapdb_add(12, STRING_INTERN);
            mapdb_add(13, LONG);
            mapdb_add(14, INTEGER);
            mapdb_add(15, ILLEGAL_ACCESS);
            mapdb_add(16, BASIC);
            mapdb_add(17, BOOLEAN);
            mapdb_add(18, BYTE_ARRAY_NOSIZE);
            mapdb_add(19, BYTE_ARRAY);
            mapdb_add(20, JAVA);
            mapdb_add(21, UUID);
            mapdb_add(22, STRING);
            mapdb_add(23, CHAR_ARRAY);
            mapdb_add(24, INT_ARRAY);
            mapdb_add(25, LONG_ARRAY);
            mapdb_add(26, DOUBLE_ARRAY);
            ...
            mapdb_add(49, BOOLEAN_ARRAY);
            mapdb_add(50, SHORT_ARRAY);
            mapdb_add(51, FLOAT_ARRAY);

            mapdb_add(52, BIG_INTEGER);
            mapdb_add(53, BIG_DECIMAL);
            mapdb_add(54, CLASS);
            mapdb_add(55, DATE);
            ...
            mapdb_add(66, RECID);
            mapdb_add(67, LONG_PACKED);
            mapdb_add(68, LONG_PACKED_ZIGZAG);
            mapdb_add(69, INTEGER_PACKED);
            mapdb_add(70, INTEGER_PACKED_ZIGZAG);
            mapdb_add(71, RECID_ARRAY);
        }
