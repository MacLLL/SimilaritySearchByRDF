...
public final class Pump {
     ...
     * To sort unordered data use {@link Pump#sort(Iterator, boolean, int, Comparator, Serializer, Executor)}
     *
     ...
     * @throws DBException.PumpSourceNotSorted if source iterator is not reverse sorted
     * @throws DBException.PumpSourceDuplicate if source iterator has duplicates
     */
