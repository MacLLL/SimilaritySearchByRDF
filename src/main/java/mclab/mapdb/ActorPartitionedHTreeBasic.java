...
//
//@Deprecated
//import cpslab.deploy.SharedConfiguration;
...
//    boolean persistSegment = SharedConfiguration.usePersistSegment();
//    Store storeSegment;
//    if (!persistSegment) {
...
//              SharedConfiguration.persistWorkingDir() + "table-" + tableId + "-" + storageName,
...
//    try {
////      System.out.println(partitionRamLock.toString());
...
//    System.out.println("Do the init locks");
